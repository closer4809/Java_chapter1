...
public class Ex08 {
	...
	public static void main(String[] args) {
		...
		System.out.println(7.0 / 2.0); //몫
		System.out.println(7.0 % 2.0);	//나머지
		...
		System.out.println(++a);
		System.out.println(a); // a의 값은 변했을까? --> ㅇㅇ
		
		System.out.println(b);
		System.out.println(--b);
		System.out.println(b); // b의 값은 변했을까?  --> ㅇㅇ
		
		System.out.println("증감연산자 뒤---------------------------");
		System.out.println(a);	// a --> 8
		System.out.println(a++); //딴거 부터 한다?
		System.out.println(a);
